...
REFERENCE_FILES = {
    ...
    "1st_secandory": {
        ...
        "الأحياء": [
            {"label": "كتاب الأحياء", "file": "biology.pdf"}
        ],
        "التربية الإسلامية": [
            {"label": "كتاب التربية الإسلامية", "file": "Islamic.pdf"}
        ],
        "النحو والصرف والإملاء": [
            {"label": "كتاب النحو والصرف والإملاء", "file": "NAHO.pdf"}
        ],
        "دراسات أدبية": [
            {"label": "كتاب الدراسات الأدبية", "file": "Literary.pdf"}
        ],
        "الكيمياء": [
            {"label": "كتاب الكيمياء", "file": "chemistry.pdf"}
        ],
        "فيزياء": [
            {"label": "كتاب الفيزياء", "file": "physics.pdf"}
        ],
        "تاريخ": [
            {"label": "كتاب التاريخ", "file": "history.pdf"}
        ],
        "الجغرافية": [
            {"label": "كتاب الجغرافية", "file": "geography.pdf"}
        ],
        "علم اجتماع": [
            {"label": "كتاب علم الاجتماع", "file": "Sociology.pdf"}
        ],
        "لغة إنجليزية": [
            {"label": "كتاب اللغة الإنجليزية", "file": "english.pdf"}
        ]
    ...
    "2nd_secandory_L": {
        ...
        "بلاغة": [
            {"label": "كتاب البلاغة", "file": "Rhetoric.pdf"}
        ],
        "الأدب والنصوص": [
            {"label": "كتاب الأدب والنصوص", "file": "Literature.pdf"}
        ],
        "المطالعة والإنشاء": [
            {"label": "كتاب المطالعة والإنشاء", "file": "Reading and writing.pdf"}
        ],
        "النحو والصرف والإملاء": [
            {"label": "كتاب النحو والصرف والإملاء", "file": "naho.pdf"}
        ],
        "الفلسفة": [
            {"label": "كتاب الفلسفة", "file": "Philosophy.pdf"}
        ],
        "التاريخ": [
            {"label": "كتاب التاريخ", "file": "history.pdf"}
        ],
        ...
        "الإحصاء": [
            {"label": "كتاب الإحصاء", "file": "statistics.pdf"}
        ],
        "تقنية المعلومات": [
            {"label": "كتاب تقنية المعلومات - الجزء الأول", "file": "IT1.pdf"},
            {"label": "كتاب تقنية المعلومات - الجزء الثاني", "file": "IT2.pdf"}
        ],
        "علم الاجتماع": [
            {"label": "كتاب علم الاجتماع", "file": "sociology.pdf"}
        ]
    ...
    "2nd_secandory_s": {
        ...
        "دراسات لغوية": [
            {"label": "كتاب الدراسات اللغوية", "file": "Linguistic.pdf"}
        ],
        "دراسات أدبية": [
            {"label": "كتاب الدراسات الأدبية", "file": "Literary.pdf"}
        ],
        "الرياضيات": [
            {"label": "كتاب الرياضيات", "file": "math.pdf"}
        ],
        "تقنية المعلومات": [
            {"label": "كتاب تقنية المعلومات - الجزء الأول", "file": "IT1.pdf"},
            {"label": "كتاب تقنية المعلومات - الجزء الثاني", "file": "IT2.pdf"}
    ...
    "3rd_secandory_L": {
        ...
        "بلاغة": [
            {"label": "كتاب البلاغة (النقد الأدبي)", "file": "Literary_criticism.pdf"}
        ],
        "الأدب والنصوص": [
            {"label": "كتاب الأدب والنصوص", "file": "Literature.pdf"}
        ],
        "المطالعة والإنشاء": [
            {"label": "كتاب المطالعة والإنشاء", "file": "reading&writting.pdf"}
        ],
        "النحو والصرف والإملاء": [
            {"label": "كتاب النحو والصرف والإملاء", "file": "naho.pdf"}
        ],
        ...
        "تقنية المعلومات": [
            {"label": "كتاب تقنية المعلومات", "file": "IT.pdf"}
        ],
        "علم الاجتماع": [
            {"label": "كتاب علم الاجتماع (علم النفس)", "file": "psychology.pdf"}
        ]
    },
    "3rd_secandory_S": {
        "التربية الإسلامية": [
        ...
        "الفيزياء": [
            {"label": "كتاب الفيزياء - الجزء الأول", "file": "physics1.pdf"},
            {"label": "كتاب الفيزياء - الجزء الثاني", "file": "physics2.pdf"}
        ],
        "الإحصاء": [
            {"label": "كتاب الإحصاء", "file": "statistics.pdf"}
        ],
